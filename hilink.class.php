...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public function getSmsForDb($box, $asArray) {
	...
	public function getUnreadSmsForDb($asArray) {
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	public function printSmsBox($box = 0) {
		switch ($box) {
			case 1: return $this->getSmsInbox(false); break;
			case 2: echo $this->getSmsOutbox(false); break;
			case 3: echo $this->getSmsDraft(false); break;
			default:
				//echo "Inbox:".PHP_EOL;
				//echo $this->getSmsInbox(false).PHP_EOL."</br></br>";
				echo "Outbox:".PHP_EOL;
				echo $this->getSmsOutbox(false).PHP_EOL."</br></br>";
				echo "Draft:".PHP_EOL;
				echo $this->getSmsDraft(false)."</br></br>";
				break;
		}
	}
